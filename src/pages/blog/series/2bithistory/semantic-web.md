...
desc: >
    ...
    article in Scientific American. Since its introduction only a decade before,
    the web had fast become the world's best means for sharing documents with 
    other people. Now, the web would evolve to encompass not just documents but
    every kind of data one could imagine.
year: 2001
date: 2018-05-27
layout: post
published: true
...
![](/2bithistory/scientific_american_cover.jpg)
...
discussed](/blog/series/2bithistory/the-rise-and-rise-of-json/) on this
...
[^4]: Doctorow, Cory. "'Metacrap' and the History of the Semantic Web." [E-mail message](/2bithistory/doctorow.txt) to author. May 11, 2018.
