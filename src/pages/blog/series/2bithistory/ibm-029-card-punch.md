...
desc:  >
    A glimpse into how programming was done back in the 1960s the era of punch card
    programming. Trace the evolution of our early programming tools - "When they were
    first invented, punch cards were punched with circular holes, but IBM realized
    that they could fit more columns on a card if the holes were narrow rectangles"
    Bonus: Get to know where the the 80 character limit in programming came from!
year: 1964
date: 2018-06-23
layout: post
published: true
