...
desc: >
    ...
    decade, inspiring a heroic engineering effort that culminated in Neil Armstrong's
    first steps on the lunar surface. But the Apollo Program was so staggeringly complex
    that new technologies had to be invented even to do the mundane things. One of these
    technologies was IBM's Information Management System (IMS).
date: 2017-10-07
layout: post
published: true
author:
...
![](/2bithistory/hierarchical-model.png)

And an actual database might look like:

![](/2bithistory/hierarchical-db.png)
